...
If you discover a security vulnerability in this project, please report it using [GitHub Security Advisories](https://github.com/magnusakselvoll/arcade-cabinet-app-switcher/security/advisories/new). This allows for private discussion of the issue before public disclosure.

For non-sensitive security issues (e.g., hardening suggestions, missing headers), feel free to open a regular [GitHub issue](https://github.com/magnusakselvoll/arcade-cabinet-app-switcher/issues).
